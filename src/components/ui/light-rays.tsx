...
export function LightRays({
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "pointer-events-none absolute left-0 right-0 top-0 isolate overflow-visible rounded-[inherit]",
        className
      )}
      style={
        {
      ...
      {...props}
    >
      <div className="absolute left-0 right-0 top-0 h-screen overflow-visible">
        <div
          aria-hidden
